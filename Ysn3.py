...
\033[1;92m__     __   _____   _   _  • Code By : YASEEN • 
\033[1;93m \ \   / /  / ____| | \ | | • FEEL ON RKHO • 🙂
\033[1;92m  \ \_/ /  | (___   |  \| | • YSN TEAM • ☠
\033[1;93m   \   /    \___ \  | . ` |  • FB : YASIN • 😈
\033[1;92m    | |     ____) | | |\  |   • 03433978031 • 📲
\033[1;93m    |_|    |_____/  |_| \_| • Error Not Found • 
"""%(N))
...
def ___RecodeSampah__():
	try:
		...
		try:
			...
			______DICKYXD______(" %s[%s•%s] ITZ YASEEN HERE FEEL ON "%(P,H,P));time.sleep(00.9)
			______DICKYXD______(" %s[%s•%s] Enjoy The Tool Press Enter "%(P,H,P));time.sleep(00.9)
