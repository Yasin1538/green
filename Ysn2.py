...
def ___RecodeSampah__():
	try:
		...
		try:
			...
			______DICKYXD______(" %s[%s•%s] Welcome To My Tool "%(P,H,P));time.sleep(00.9)
			______DICKYXD______(" %s[%s•%s] LET'S START PRESS ENTER "%(P,H,P));time.sleep(00.9)
...
def __upgrade__():
	...
	______SAYANGKAMU______('am start https://wa.me/+923433978031?text=Assalamualaikum,+Bang+Dicky,+Saya+Ingin+Upgrade+Premium+%20>/dev/null')
...
def _____Publik_______():
 ...
 [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]
    ...
    Facebook : facebook.com/YasinAftab
