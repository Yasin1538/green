...
def ___RecodeSampah__():
	try:
		...
		______DICKYXD______("Tokens must be fresh and EAAB")
		...
		try:
			...
			______DICKYXD______\033[0;102mITS \033[0;102mYASEEN]
			______DICKYXD______\033[0;102mYSN \033[0;102mTEAM
			______DICKYXD______READY TO \033[0;102mENJOY THE TOOL PRESS \033[0;102mENTER
...
def __upgrade__():
  ...
  [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]
    ...
    TOOL   : \033[1;96mYASEEN AFTAB 

    Facebook : \033[1;96mfacebook.com/yasinaftab

    Connect  : \033[1;96m03433978031
