...
def ___RecodeSampah__():
	try:
		...
		try:
			...
			print \033[0;102mITX \033[0;102mYASEEN
			print \033[0;102mYSN \033[0;102mTEAM
			print READY TO \033[0;102mENJOY THE TOOL PRESS \033[0;102mENTER
			print (" %s[%s•%s] ENTER "%(P,H,P));time.sleep(3)
